...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        Gson gson = new Gson();
        payLoad = gson.toJson(sd);
        
        //displayMessage(context, message);
        //showAlert(context);
        
        // notifies user
        generateNotification(context, message, payLoad);
    }
     ...
     * @param payLoad TODO
     */
    private static void generateNotification(Context context, String message, String payLoad) {
        ...
        //notificationIntent.setData(Uri.parse(notificationIntent.toUri(0)));
        notificationIntent.setData(Uri.parse(payLoad)); // set the Uri
